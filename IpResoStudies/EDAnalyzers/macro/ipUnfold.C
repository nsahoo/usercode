...
void ipUnfold(int type=1,int typePlot=0,int typePlot2=1,int typePlot3=0)
{
  ...
  switch ( type )
    ...
    case 1: //d0 vs pt
      ...
      hname5 ="sim_raw_d0Err_vsPt_n"; //raw error MC
      hname6 ="data_raw_d0Err_vsPt_n"; //raw error DATA
      fitRangeMax = 400;
      break;
    ...
    case 2: //d0 vs eta
      ...
      hname5 ="sim_raw_d0Err_vsEta_n"; //raw error MC
      hname6 ="data_raw_d0Err_vsEta_n"; //raw error DATA
      fitRangeMax = 600;
      break;
    ...
    case 3: //d0 vs phi
      ...
      hname5 ="sim_raw_d0Err_vsPhi_n"; //raw error MC
      hname6 ="data_raw_d0Err_vsPhi_n"; //raw error DATA
      fitRangeMax = 400;
      break;
    ...
    case 4: //dz vs pt
      ...
      hname5 ="sim_raw_dzErr_vsPt_n"; //raw error MC
      hname6 ="data_raw_dzErr_vsPt_n"; //raw error DATA
      fitRangeMax = 1500;
      break;
    ...
    case 5: //dz vs eta
      ...
      hname5 ="sim_raw_dzErr_vsEta_n"; //raw error MC
      hname6 ="data_raw_dzErr_vsEta_n"; //raw error DATA
      fitRangeMax = 1500;
      break;
    ...
    case 6: //dz vs phi
      ...
      hname5 ="sim_raw_dzErr_vsPhi_n"; //raw error MC
      hname6 ="data_raw_dzErr_vsPhi_n"; //raw error DATA
      fitRangeMax = 1500;
      break;
  ...
  if(type==2){
    ...
    fnRawErrSim  = inputFolderName+"sim.raw.d0Err.vsEta.50bins.root";
    fnRawData    = inputFolderName+"data.raw.d0.vsEta.50bins.root";
    fnRawErrData = inputFolderName+"data.raw.d0Err.vsEta.50bins.root";
  ...
  if(type==5){
    ...
    fnRawErrSim  = inputFolderName+"sim.raw.dzErr.vsEta.50bins.root";
    fnRawData    = inputFolderName+"data.raw.dz.vsEta.50bins.root";
    fnRawErrData = inputFolderName+"data.raw.dzErr.vsEta.50bins.root";
