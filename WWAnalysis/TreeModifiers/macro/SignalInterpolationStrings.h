...
std::string getSignalEBELandauMeanString(int ch, bool do7TeV) {
  stringstream fss;
  if (do7TeV) {
    if (ch == 0) fss << "(0.0339564) + (-0.000426172*@0) + (1.74496e-06*@0*@0)";
    if (ch == 1) fss << "(0.0829842) + (-0.00116092*@0) + (4.7262e-06*@0*@0)";
    if (ch == 2) fss << "(0.0132359) + (-5.35103e-05*@0) + (2.12947e-07*@0*@0)";
  } 
  else {
...
std::string getSignalEBEGaussianMeanString(int ch, bool do7TeV) {
  stringstream fss;
  if (do7TeV) {
    if (ch == 0) fss << "(-0.0457272) + (0.000921588*@0) + (-3.78018e-06*@0*@0)";
    if (ch == 1) fss << "(-0.10775) + (0.00220625*@0) + (-9.37724e-06*@0*@0)";
    if (ch == 2) fss << "(-0.0916811) + (0.00187322*@0) + (-7.96086e-06*@0*@0)";
  } 
  else {
...
std::string getSignalEBEGaussianSigmaString(int ch, bool do7TeV) {
  stringstream fss;
  if (do7TeV) {
    if (ch == 0) fss << "(0.0282721) + (-0.000436521*@0) + (1.80129e-06*@0*@0)";
    if (ch == 1) fss << "(0.037064) + (-0.000533085*@0) + (2.19423e-06*@0*@0)";
    if (ch == 2) fss << "(-0.0138837) + (0.000319177*@0) + (-1.37735e-06*@0*@0)";
  } 
  else {
...
std::string getSignalEBELandauFracString(int ch, bool do7TeV) {
  stringstream fss;
  if (do7TeV) {
    if (ch == 0) fss << "(21.5783) + (-0.344499*@0) + (0.00141962*@0*@0)";
    if (ch == 1) fss << "(-4.28143) + (0.0785516*@0) + (-0.00032387*@0*@0)";
    if (ch == 2) fss << "(3.35634) + (-0.0457357*@0) + (0.000190548*@0*@0)";
  } 
  else {
