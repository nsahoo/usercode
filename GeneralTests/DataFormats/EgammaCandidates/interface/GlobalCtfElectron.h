#ifndef GlobalCtfElectron_h
#define GlobalCtfElectron_h
/** \class reco::Electron 
 *
...
class GlobalCtfElectron : public RecoCandidate {

 public:
  
  GlobalCtfElectron() {;} 

  GlobalCtfElectron(const SuperClusterRef scl, const TrackRef gsft,
